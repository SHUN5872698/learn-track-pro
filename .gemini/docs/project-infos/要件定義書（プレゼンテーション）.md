...
![画面フロー](../designs/decisions/画面フロー2025-0907.png)
...
| string | name | NULLABLE | ユーザー名 |
| string | avatar | NOT NULL | プロフィール画像 |
...
| string | description | NOT NULL | カテゴリーの説明 |
| timestamp | created_at | NOT NULL | レコード作成日時 |
| timestamp | updated_at | NOT NULL | レコード最終更新日時 |
...
| bigint | learning_content_id | FOREIGN KEY | 学習内容ID (learning_contents.id参照) |
