...
.gemini/docs/apis/endpoint-docs/Dev/学習記録API.md
...
- **Response 200:**
    ...
    ```json
    {
        "total_study_minutes": "18270",
        "completed_courses_count": 1,
        "average_study_time_per_day": 190,
...
| days | integer | 取得する日数（デフォルト: 30） |
| learningContentId | integer | 学習記録ID |
- **Response 200:**（例: days=30,learningContentId=2の場合）
