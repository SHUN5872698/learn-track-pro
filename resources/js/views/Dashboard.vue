...
// ========================================
/**
 * 進行中の学習内容をフィルタリングし、優先度順にソート
 *
 * ソートの優先順位（上から順に適用）:
 * 1. 最新の学習記録がある学習内容を先頭に配置
 * 2. 「学習中」を「未着手」より先頭に配置
 * 3. 学習内容自体の更新日時が新しいものを先頭に配置
 *
 * sort()の比較関数の仕組み:
...
/**
 * 完了した学習内容をフィルタリングし、優先度順にソート
 *
 * ソートの優先順位（上から順に適用）:
 * 1. 最新の学習記録がある学習内容を先頭に配置
 * 2. 学習内容自体の更新日時が新しいものを先頭に配置
 */
