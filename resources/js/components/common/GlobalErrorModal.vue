          ...
          >
            <DialogPanel class="relative px-4 pt-5 pb-4 overflow-hidden text-left transition-all transform bg-white rounded-lg shadow-xl sm:my-8 sm:w-full sm:max-w-lg sm:p-6">
              ...
              <div class="mt-5 sm:mt-4 sm:flex sm:flex-row-reverse">
                <button type="button" class="inline-flex justify-center w-full px-3 py-2 text-sm text-white rounded-md shadow-sm bg-violet-600 hover:bg-violet-500 sm:ml-3 sm:w-auto" @click="handleReload">ページを再読み込み</button>
                <button type="button" class="inline-flex justify-center w-full px-3 py-2 mt-3 text-sm text-gray-900 bg-white rounded-md shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50 sm:mt-0 sm:w-auto" @click="handleBackToDashboard">ダッシュボードへ戻る</button>
              </div>
            </DialogPanel>
          </TransitionChild>
        </div>
